...
Agora basta abrir o projeto e apertar F11 (Build Project) ou clicar com o botão direito no ícone do projeto (la-lexico) e selecionar a opção build
...
java -jar la-lexico-1.0-SNAPSHOT-jar-with-dependencies.jar programa.txt saida.txt

programa.txt é o arquivo que contém o programa escrito na linguagem LA, e saida.txt irá conter os tokens resultantes da análise léxica.
